...
$(ACC_EXE): $(HOST_SRC_FILES) 
	$(CXX) $(CXX_FLAGS) $(CXX_ACC_HW_FLAGS) $^ -o $(ACC_EXE) -I/opt/Xilinx/Vivado/2019.1.op2552052/include

mcc_accsimexe $(ACC_SIM_EXE): $(HOST_SRC_FILES) 
	$(CXX) $(CXX_FLAGS) $(CXX_ACC_SIM_FLAGS) $^ -o $(ACC_SIM_EXE) -I/opt/Xilinx/Vivado/2019.1.op2552052/include
